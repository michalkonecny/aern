...
--        sineOutPoly, sineOutPolyThin,
        module Numeric.AERN.RmToRn.Basis.Polynomial.IntPoly.Config,
...
import Numeric.AERN.RmToRn.Basis.Polynomial.IntPoly.DomBoxChanges
...
import Numeric.AERN.RmToRn.Basis.Polynomial.IntPoly.ConsistentCoeffs.Multiplication
