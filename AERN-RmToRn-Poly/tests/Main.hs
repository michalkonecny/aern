...
testMutableGCPolys =
    ...
    putStrLn $ "copyEncl 0 pb223 = " ++ showP cp0pb223
    where
    showP = showInternals (showChebTerms, showCoeffInternals)
    showChebTerms = True
    showCoeffInternals = False
    ...
    [p1,p2,p3,p11,p12,p22,p1b23,pb223,p23s1,pb223s1,pb223d0,sux,sdx,sex,rd0pb223,cp0pb223] = runST $
        do
