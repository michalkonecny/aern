...
import Numeric.AERN.Basics.NumericOrder.Comparison hiding ((==))
...
propLatticeComparisonCompatible :: (Eq t, Comparison t, Lattice t) => UniformlyOrderedPair t -> Bool
propLatticeComparisonCompatible (UniformlyOrderedPair (e1,e2)) = 
    (joinOfOrderedPair (==) (<=) max e1 e2)
    && 
    (meetOfOrderedPair (==) (<=) min e1 e2) 

propLatticeComparisonCompatibleNonReflexive :: (Eq t, Comparison t, Lattice t) => UniformlyOrderedPair t -> Bool
propLatticeComparisonCompatibleNonReflexive (UniformlyOrderedPair (e1,e2)) = 
    (joinOfOrderedPairNonReflexive (==) (<=) max e1 e2)
    && 
    (meetOfOrderedPairNonReflexive (==) (<=) min e1 e2) 

propLatticeJoinAboveBoth :: (Eq t, Comparison t, Lattice t) => UniformlyOrderedPair t -> Bool
propLatticeJoinAboveBoth (UniformlyOrderedPair (e1,e2)) = joinAboveOperands (<=) max e1 e2

propLatticeMeetBelowBoth :: (Eq t, Comparison t, Lattice t) => UniformlyOrderedPair t -> Bool
propLatticeMeetBelowBoth (UniformlyOrderedPair (e1,e2)) = meetBelowOperands (<=) min e1 e2

propLatticeJoinIdempotent :: (Eq t, Comparison t, Lattice t) => t -> Bool
propLatticeJoinIdempotent = idempotent (==) max

propLatticeJoinCommutative :: (Eq t, Comparison t, Lattice t) => UniformlyOrderedPair t -> Bool
propLatticeJoinCommutative (UniformlyOrderedPair (e1,e2)) = commutative (==) max e1 e2

propLatticeJoinAssocative :: (Eq t, Comparison t, Lattice t) => UniformlyOrderedTriple t -> Bool
propLatticeJoinAssocative (UniformlyOrderedTriple (e1,e2,e3)) = associative (==) max e1 e2 e3

propLatticeMeetIdempotent :: (Eq t, Comparison t, Lattice t) => t -> Bool
propLatticeMeetIdempotent = idempotent (==) min

propLatticeMeetCommutative :: (Eq t, Comparison t, Lattice t) => UniformlyOrderedPair t -> Bool
propLatticeMeetCommutative (UniformlyOrderedPair (e1,e2)) = commutative (==) min e1 e2

propLatticeMeetAssocative :: (Eq t, Comparison t, Lattice t) => UniformlyOrderedTriple t -> Bool
propLatticeMeetAssocative (UniformlyOrderedTriple (e1,e2,e3)) = associative (==) min e1 e2 e3

{- optional properties: -}
propLatticeModular :: (Eq t, Comparison t, Lattice t) => UniformlyOrderedTriple t -> Bool
propLatticeModular (UniformlyOrderedTriple (e1,e2,e3)) = modular (==) max min e1 e2 e3

propLatticeDistributive :: (Eq t, Comparison t, Lattice t) => UniformlyOrderedTriple t -> Bool
